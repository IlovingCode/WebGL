...
class TestScene extends Scene {
  init() {
    ...
    const center = new Point(display.width * 0.51, display.height * 0.1);
  ...
  update(dt) {
    ...
    if (this.character.sprite.position.y > display.height) {
      this.character.sprite.position.y = display.height * 0.1;
      this.character.sprite.v.y = 10;
    }
