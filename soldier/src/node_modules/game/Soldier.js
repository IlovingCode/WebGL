...
export class TrackingCameraComponent {
    ...
    update(dt) {
        this.camera.pivot.x += (this.target.x - this.cam.pivot.x) * this.speed.x * dt;
        this.camera.pivot.y += (this.target.y - this.cam.pivot.y) * this.speed.y * dt;
    }
}
