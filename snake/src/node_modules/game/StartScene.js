...
import { AutoComponent } from 'game/Components';
import { MissionCommon } from 'game/MissionCommon';
...
export class StartScene extends Scene {
  init() {
    ...
    this.fake.auto = new AutoComponent(this.fake);
    this.fake.auto.setPath(this.foods);
  }

  onTouch() {
    this.character.control.turnLeft = !this.character.control.turnLeft;
  }
  ...
  endGame() {
    ...
    return new MissionCommon;
  }

  update(dt) {
    this.character.update(dt);
    this.fake.update(dt);
    this.fake.auto.update();
