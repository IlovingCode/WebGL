...
class TestScene extends Scene {
  init() {
    ...
    this.bound = new Rectangle(topLeft.x, topLeft.y, display.width * 0.8, display.height * 0.8);

    this.character = new Head(center, this.stage);
    this.fake = new FakeHead(new Point(display.width * 0.25, display.height * 0.5), this.stage);
